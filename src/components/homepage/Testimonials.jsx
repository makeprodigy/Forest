    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center px-3 py-1 sm:px-4 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-4 sm:mb-6">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4">What Our Users Say</h2>
          <p className="text-base sm:text-lg lg:text-xl text-white/70 max-w-2xl mx-auto px-4">Real feedback from our community of buyers and sellers</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
          {visible.map((testimonial, index) => (
            ...
            >
              ...
              {/* Feedback */}
              <p className="text-white/90 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-lg">
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
          <div className="group">
            <div className="flex items-center justify-center mb-3 sm:mb-4">
              <div className="p-3 sm:p-4 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl backdrop-blur-sm">
            ...
            <div className="text-white/70 text-sm sm:text-base">Customer Satisfaction</div>
          </div>
          <div className="group">
            <div className="flex items-center justify-center mb-3 sm:mb-4">
              <div className="p-3 sm:p-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl backdrop-blur-sm">
          ...
          <div className="group">
            <div className="flex items-center justify-center mb-3 sm:mb-4">
              <div className="p-3 sm:p-4 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-2xl backdrop-blur-sm">
            ...
            <div className="text-white/70 text-sm sm:text-base">Customer Support</div>
          </div>
        </div>
      </div>
    </section>
